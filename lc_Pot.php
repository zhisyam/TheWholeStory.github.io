...
<head>
    ...
    fetch('check_login.php')
        ...
        .then(data => {
            if (data.loggedIn) {
                const productName = "Le Creuset Pot Rice ";
...
<body>
    ...
    <div class="container">
       ...
       <nav>
        ...
        <main>
            <h1>Le Creuset Pot Rice</h1>

            <div class="product-details">
                <img class="product-image red-image" src="21110184230449_01.jpg" alt="Le Creuset Pot Rice Peach">
                <img class="product-image red-image hidden" src="21110184230449_02.jpg" alt="Le Creuset Pot Rice Peach Side">
                <img class="product-image red-image hidden" src="21110184230449_04.jpg" alt="Le Creuset Pot Rice Peach Top">

                <img class="product-image marine-image hidden" src="21110187710442_01.jpg" alt="Le Creuset Pot Rice Sage">
                <img class="product-image marine-image hidden" src="21110187710442_02.jpg" alt="Le Creuset Pot Rice Sage Side">
                <img class="product-image marine-image hidden" src="21110187710442_04.jpg" alt="Le Creuset Pot Rice Sage Top">

                <img class="product-image black-image hidden" src="21110184230449_01.jpg" alt="Le Creuset Marmite Black">
                <img class="product-image black-image hidden" src="21114240000430_02.jpg" alt="Le Creuset Marmite Black Side">
                <img class="product-image black-image hidden" src="21114240000430_04.jpg" alt="Le Creuset Marmite Black Top">
                <h2>Select Color:</h2>
                <select id="color" onchange="updateImage()">
                    <option value="red">Peach</option>
                    <option value="marine">Sage</option>
                    <option value="black">Black</option>
                </select>

                <h2>Select Size:</h2>
                <select id="size" onchange="updatePrice()">
                    <option value="18">24 cm</option>
                    <option value="20">26 cm</option>
                    
                    
                </select>

                <p id="price-display">$220.00</p>
