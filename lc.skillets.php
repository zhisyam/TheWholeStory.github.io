...
<body>
    ...
    <div class="container">
       ...
       <nav>
        ...
        <main>
            <h1>Le Creuset Skillet</h1>

            <div class="product-details">
                <img class="product-image red-image" src="20182230900422_01.jpg" alt="Le Creuset Casserole Red">
                <img class="product-image red-image hidden" src="20182230900422_02.jpg" alt="Le Creuset Casserole Red Side">
                <img class="product-image red-image hidden" src="20182230900422_04.jpg" alt="Le Creuset Casserole Red Top">

                <img class="product-image marine-image hidden" src="20182200600422_01.jpg" alt="Le Creuset Casserole Marine">
                <img class="product-image marine-image hidden" src="20182200600422_02.jpg" alt="Le Creuset Casserole Marine Side">
                <img class="product-image marine-image hidden" src="20182200600422_04.jpg" alt="Le Creuset Casserole Marine Top">

                <img class="product-image black-image hidden" src="20182167770422_01.jpg" alt="Le Creuset Casserole Cool Mint">
                <img class="product-image black-image hidden" src="20182167770422_02.jpg" alt="Le Creuset Casserole Cool Mint Side">
                <img class="product-image black-image hidden" src="20182167770422_04.jpg" alt="Le Creuset Casserole Cool Mint Top">
                <h2>Select Color:</h2>
                <select id="color" onchange="updateImage()">
                    <option value="red">Flame</option>
                    <option value="marine">Cerise</option>
                    <option value="black">Shell Pink</option>
                </select>
